...
import Fragments.SingleProductCartFragment
...
class CartProductsAdapter (var context: Context, productsData: ArrayList<ProductsModel>) :
    RecyclerView.Adapter<CartProductsAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onClick(view: View) {
            ...
            val singleProductCartFragment = SingleProductCartFragment()
            val bundle = Bundle()
            ...
            singleProductCartFragment.setArguments(bundle)
            transaction.replace(R.id.fl_Card, singleProductCartFragment)
