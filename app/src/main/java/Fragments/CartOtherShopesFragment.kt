 ...
 * Use the [CartOtherShopesFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CartOtherShopesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cart_other_shopes, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment CartOtherShopesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CartOtherShopesFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById(R.id.rv_OtherShopes)
